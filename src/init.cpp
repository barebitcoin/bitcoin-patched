...
static constexpr bool DEFAULT_DRIVECHAIN{false};
...
#endif
    argsman.AddArg("-drivechain", strprintf("Activate drivechain fork (default: %u)", DEFAULT_DRIVECHAIN), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
